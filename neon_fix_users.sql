...
-- 1. Créer le type ENUM pour subscription_tier
DO $$ BEGIN
...
-- 2. Créer le type ENUM pour platform
DO $$ BEGIN
...
-- 3. Supprimer les tables dans l'ordre (à cause des foreign keys)
...
-- 4. Recréer la table users avec la bonne structure
CREATE TABLE users (
...
-- 14. Recréer user_style_profiles
